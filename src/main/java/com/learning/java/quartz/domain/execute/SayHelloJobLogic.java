package com.learning.java.quartz.domain.execute;
...
public class SayHelloJobLogic implements Job {
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        log.info(jobExecutionContext.getJobDetail().toString());
        log.info(jobExecutionContext.getJobDetail().getJobDataMap().get(1).toString());
    }
}
